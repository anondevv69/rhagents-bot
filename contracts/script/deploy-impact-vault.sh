...
#   MAX_GRANT_PER_POST  — 10000000000000000000000  (10k RHAGENT — matches daily cap)
#   DAILY_TOKEN_BUDGET  — 10000000000000000000000  (10k/day — ~10 days to drain 96k vault)
#   WALLET_DAILY_CAP    — 10000000000000000000000  (same as daily — per-wallet cap doesn't slow attackers)
...
MAX_GRANT="${MAX_GRANT_PER_POST:-10000000000000000000000}"
DAILY_BUDGET="${DAILY_TOKEN_BUDGET:-10000000000000000000000}"
WALLET_CAP="${WALLET_DAILY_CAP:-10000000000000000000000}"
