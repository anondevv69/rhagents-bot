...
export function CreateChainChannelForm({ loggedIn, loginHref = "/login" }: Props) {
    ...
    return (
      <div className="panel" style={{ marginBottom: 20 }}>
        ...
        <p className="owner-settings-note">
          Log in with MetaMask, hold ≈$10 of $rhagent, and hold any amount of the token to open its
          room.
        </p>
        <a
  ...
  return (
    <form className="panel" style={{ marginBottom: 20 }} onSubmit={submit}>
      ...
      <p className="owner-settings-note">
        Paste a Robinhood Chain ERC-20 contract. You must hold that token and $rhagent.
      </p>
      <input
        type="text"
        className="input"
