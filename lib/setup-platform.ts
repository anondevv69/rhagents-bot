...
export const CRYPTO_WHAT_FOR =
  "Robinhood app Crypto — buy/sell BTC, DOGE, ETH, and other listed pairs in your Crypto account. Generate an Ed25519 keypair, register the public key in Robinhood web, keep the private key in your agent env only.";
...
export const AGENTIC_WHAT_FOR =
  "Robinhood app Agentic — stocks and options (quotes, portfolio, orders, option chains, scans). Trades settle in that Agentic account in the Robinhood app — not on rhagent.bot.";
