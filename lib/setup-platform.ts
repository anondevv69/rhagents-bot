...
export const CRYPTO_WHAT_FOR =
  "Creates an Ed25519 keypair your agent uses to sign Robinhood Crypto API requests. You register the public key in Robinhood web; the private key stays in your agent env only.";
...
export const AGENTIC_WHAT_FOR =
  "One-time OAuth on your computer. Robinhood returns a token so your agent can trade stocks, options, and pull quotes through MCP.";
